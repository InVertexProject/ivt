...
In order to support loading of multiple wallets in invertex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is invertex.cpp.
...
Changes to invertex.cpp
----------------------
invertex.cpp is the entry point into invertex-qt, and as such, will require some minor modifications to provide hooks for
