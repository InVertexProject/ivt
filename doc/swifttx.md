...
This mechanism has been integrated into Bitcore-Node-InVertex which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/InVertex-Project/insight-api-invertex#web-socket-api](https://github.com/InVertex-Project/insight-api-invertex#web-socket-api)
* API: [https://github.com/InVertex-Project/insight-api-invertex#swifttx-transactions](https://github.com/InVertex-Project/insight-api-invertex#swifttx-transactions)
...
By default, the InVertex Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the InVertex Core daemon:
