...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("InVertex Core invertex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  invertex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded invertex transaction") + "\n" +
                               "  invertex-tx [options] -create [commands]   " + _("Create hex-encoded invertex transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded invertex transaction
