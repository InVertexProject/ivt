...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop InVertex server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "InVertex server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* InVertex features */
        {"invertex", "masternode", &masternode, true, true, false},
        {"invertex", "listmasternodes", &listmasternodes, true, true, false},
        {"invertex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"invertex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"invertex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"invertex", "masternodedebug", &masternodedebug, true, true, false},
        {"invertex", "startmasternode", &startmasternode, true, true, false},
        {"invertex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"invertex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"invertex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"invertex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"invertex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"invertex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"invertex", "mnbudget", &mnbudget, true, true, false},
        {"invertex", "preparebudget", &preparebudget, true, true, false},
        {"invertex", "submitbudget", &submitbudget, true, true, false},
        {"invertex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"invertex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"invertex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"invertex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"invertex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"invertex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"invertex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"invertex", "checkbudgets", &checkbudgets, true, true, false},
        {"invertex", "mnsync", &mnsync, true, true, false},
        {"invertex", "spork", &spork, true, true, false},
        {"invertex", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"invertex", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use invertexd, or the -server option to invertex-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> invertex-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:27413/\n";
}
