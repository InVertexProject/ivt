...
/** Utility functions used by the InVertex Qt UI.
 */
namespace GUIUtil
{
...
// Render InVertex addresses in monospace font
...
// Parse "invertex:" URI into recipient object, return true on successful parsing
