...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("InVertex Core"),
     ...
     * override -datadir in the invertex.conf file in the default data directory
     * (to be consistent with invertexd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
