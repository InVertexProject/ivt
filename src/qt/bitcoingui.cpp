                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("InVertex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a InVertex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and invertex: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About InVertex Core"), this);
    aboutAction->setStatusTip(tr("Show information about InVertex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for InVertex"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your InVertex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified InVertex addresses"));
    ...
    openAction->setStatusTip(tr("Open a InVertex: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the InVertex Core help message to get a list with possible InVertex command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("InVertex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to InVertex network", "", count));
}
...
{
    QString strTitle = tr("InVertex Core"); // default title
